...
from train_utils import calculate_running_time, read_file, generate_abs_path, read_yaml_file, read_class_config
from train_utils import multi_label_transfer, linpack_transfer, MLC_multi_label_transfer, headmap_feature
import re
import logging
...
class DataLoader():
    def __init__(self, configs, K_Fold=False, config_file="data_filter.yaml"):
        ...
        self.test = {}
        self.if_transform_cache = self.configs["if_transform_cache"]
    ...
    def run(self, K_Fold = False):
        ...
        # headmap_feature(merge_data, "./")

        if self.if_transform_cache:
            merge_data[
