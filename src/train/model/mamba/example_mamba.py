...
class Mamba2(nn.Module):
    def __init__(
        ...
        self.d_ssm = self.d_inner if args.d_ssm is None else args.d_ssm // self.world_size
        assert args.ngroups % self.world_size == 0
        self.ngroups = args.ngroups // self.world_size
