...
from utils import calculate_running_time, mkdir
from utils.model_utils import TextTokenizer
...
parent_dir = os.path.abspath(os.path.join(current_dir, "../../src/train/"))
...
class FeatureEncoder():
    ...
    def Label_encode(self, feature):
        ...
        col = feature.columns.to_list()[0]
        if self.select_model == "XgboostModel":
