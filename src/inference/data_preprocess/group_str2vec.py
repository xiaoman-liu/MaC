...
from utils import calculate_running_time, read_class_config, mkdir
from utils.model_utils import MinMaxScaler, NorScaler, OneHotEncoder, TextTokenizer
...
class GroupFeatureEmbedding():
    ...
    def run(self, filtered_features):
        ...
        return [[self.mem_processed_numa_features, self.mem_processed_char_feature],
                ...
                [self.numa_processed_features, self.char_processed_features]]
