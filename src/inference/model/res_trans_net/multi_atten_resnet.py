...
from utils.model_utils import Self_Attention, MultiHeadAtten
import os
import logging
import pandas as pd
import yaml
...
class MultiAttenResNet(BaseModel):
    def __init__(self, configs, processed_features, processed_labels):
        super().__init__( configs, processed_features, processed_labels)
        self.logger = logging.getLogger("MultiAttenResNet")
        self.mode_config = self.configs["MultiAttenResNet_config"]
