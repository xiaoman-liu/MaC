...
from utils.model_utils import Self_Attention
import os
import logging
import pandas as pd
import yaml
...
class AttenResNet(BaseModel):
    ...
    def build_model(self):
        ...
        with custom_object_scope({'customed_mse': self.customed_mse}):
            model = tf.keras.models.load_model(file, custom_objects={"Self_Attention": Self_Attention})
